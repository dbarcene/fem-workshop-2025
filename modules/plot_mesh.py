...
if element_type == '2DQU4N':
    ...
    plt.plot(np.array([x0, x1]), np.array([y0, y1]), 'red', linewidth=0.5)
    plt.plot(np.array([x1, x2]), np.array([y1, y2]), 'red', linewidth=0.5)
    plt.plot(np.array([x2, x3]), np.array([y2, y3]), 'red', linewidth=0.5)
    plt.plot(np.array([x3, x0]), np.array([y3, y0]), 'red', linewidth=0.5)
    ...
    plt.plot(np.array([x0, x1]), np.array([y0, y1]), 'red', linewidth=0.5)
    plt.plot(np.array([x1, x2]), np.array([y1, y2]), 'red', linewidth=0.5)
    plt.plot(np.array([x2, x0]), np.array([y2, y0]), 'red', linewidth=0.5)
